...
def parse_args():
    ...
    parser.add_argument("--distill-dataset", type=str, default="runs/cache/distill_dataset.pt")
    parser.add_argument("--lightweight-router", type=str, default="runs/cache/lightweight_router.pt")
