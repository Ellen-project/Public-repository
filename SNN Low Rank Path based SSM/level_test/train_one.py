...
def level_path(path: str | Path) -> Path:
    ...
    elif path_obj.parts and path_obj.parts[0] == "level_test":
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train one level_test model.")
    ...
    parser.add_argument("--output-dir", type=str, default="level_test/runs")
