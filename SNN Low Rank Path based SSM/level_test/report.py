...
def parse_args():
    parser = argparse.ArgumentParser(description="Generate level_test Markdown report.")
    parser.add_argument("--results-dir", type=str, default="level_test/results")
    parser.add_argument("--runs-dir", type=str, default="level_test/runs")
    parser.add_argument("--output", type=str, default="level_test/REPORT.md")
...
def generate_report(args) -> Path:
    ...
    if args.include_lrp_fix_analysis:
        ...
        old_gate_meta = read_torch_metadata("level_test/c4_gate_cache_medium.pt")
